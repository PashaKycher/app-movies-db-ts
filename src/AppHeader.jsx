  ...
  return (
    <AppBar position="static">
      <Toolbar>
        ...
        <Box sx={{ flexGrow: 1 }} >
          <nav>
            <HeaderLink to="app-movies-db-ts/">Home</HeaderLink>
            <HeaderLink to="app-movies-db-ts/movies">Movies</HeaderLink>
            <HeaderLink to="app-movies-db-ts/about">About</HeaderLink>
          </nav>
        </Box>
